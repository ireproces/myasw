...
public class ServiceClientProxy implements Service {
    ...
    public String alpha(String arg) {
        ...
        // porzione di CONNETTORE LATO CLIENT:
        // crea la socket per i datagrammi di richiesta, li invia, riceve i datagrammi di risposta,
        // estrae i risultati e li restituisce al client
        try {
