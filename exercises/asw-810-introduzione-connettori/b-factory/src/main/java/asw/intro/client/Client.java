...
public class Client {
	...
	public Client() {
		...
		// il servizio viene ottenuto dalla factory, questo disaccoppia direttamente il
		// client dall'implementazione del servizio ma lo rende dipendente dalla factory
		//
		// il client è ancora responsabile di soddisfare le proprie dipendenze
