...
public class ServiceClientUDPProxy implements Service {
	...
	// costruisce il datagramma di richiesta secondo il formato previsto,
	// lo invia al server,
	// riceve il datagramma di risposta,
	// estrae la risposta,
	// elabora la risposta e restituisce il risultato o solleva l'eccezione
    private String doOperation(String op, String arg) throws ServiceException, RemoteException {
        ...
        try {
             ...
             * "#risultato"
			 * "@messaggio" per eccezione di servizio
