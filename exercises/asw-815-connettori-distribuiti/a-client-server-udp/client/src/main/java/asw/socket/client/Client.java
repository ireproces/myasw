...
public class Client {
	...
	// metodo per l'invocazione dell'operazione alpha del servizio (proxy)
	// ed eventuale gestione delle eccezioni
	...
	// metodo per l'invocazione dell'operazione beta del servizio (proxy)
	// ed eventuale gestione delle eccezioni
