 ...
 * 
 * In particolare, si assume che il server NON sollevi MAI una RemoteException, mentre
 * il proxy lato client puo' sollevare una RemoteException se non riesce a comunicare
 * con il server.
 */
