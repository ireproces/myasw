...
public class ServiceServerUDPProxy {
    ...
    public void run() {
        ...
        try {
            ...
            // ciclo di servizio, in attesa di richieste
            while (true) {
    ...
    // riceve un datagramma di richiesta
    // estrae la richiesta e verifica che sia ben formata
    // invoca il servizio ed ottiene il risultato su cui calcolare la risposta
    // costruisce un datagramma di risposta
