...
@RestController
// l'annotazione applicata all'intera classe specifica il path di base da usare
// come prefisso per tutte le operazioni (metodi)
@RequestMapping(path="/rest")
public class RestaurantRestController {

	// iniezione della dipendenza sul servizio
	@Autowired 
